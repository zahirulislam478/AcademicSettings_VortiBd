...
@Injectable()
export class AdmssionUIConfigService
{
  ...
  {
    return this.service.post(UrlConfig.ADMISSION_UI_CONFIGS, model);
  }

  SaveSingleUiConfig(model: any): Observable<any>
  {
    return this.service.post(UrlConfig.ADMISSION_CLONE_UI_CONFIGS, model);
  }

  ResetSingleUiConfig(model: any): Observable<any>
  {
    return this.service.post(UrlConfig.ADMISSION_RESET_UI_CONFIGS, model);
  }
