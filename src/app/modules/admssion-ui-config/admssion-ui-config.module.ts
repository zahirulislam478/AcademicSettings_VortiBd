...
import { AdmssionUIConfigComponent } from './admssion-ui-config.component';
...
const dashboardRoutes: Route[] = [
  {
    path: "",
    component: AdmssionUIConfigComponent,
  }
];

@NgModule({
  declarations: [
    AdmssionUIConfigComponent,
...
export class AdmssionUIConfigModule
{
}
