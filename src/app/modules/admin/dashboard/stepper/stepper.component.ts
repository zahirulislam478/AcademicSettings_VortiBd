...
export class StepperApplyComponent
{
  ...
  MainAppliedPreEdu_PSC_Data = null;
  MainAppliedPreEdu_JSC_JDC_Data = null;
  MainAppliedPreEdu_SSC_Dakhil_Data = null;
  MainAppliedPreEdu_HSC_Alim_Data = null;
  MainAppliedPreEdu_Hons_Fazil_Data = null;
  MainAppliedPreEdu_Masters_Kamil_Data = null;
  MainAppliedPreEdu_BBA_Data = null;
  MainAppliedPreEdu_MBA_Data = null;
  ...
  )
  {
    ...
    // this.studentSaveData = JSON.parse(localStorage.getItem('studentSaveData'));
    // this.guardianSaveData = JSON.parse(localStorage.getItem('guardianSaveData'));
    // this.addressSaveData = JSON.parse(localStorage.getItem('addressSaveData'));
    // this.prevAcademicForSchoolSaveData = JSON.parse(localStorage.getItem('prevAcademicForSchoolSaveData'));
    // this.prevAcademicForCollegeSaveData = JSON.parse(localStorage.getItem('prevAcademicForCollegeSaveData'));
    // this.courseCurriculumSaveData = JSON.parse(localStorage.getItem('courseCurriculumSaveData'));
    ...
    if (this.FormParam.SelectedProgramType == "S")
    {
  ...
  public onStepChange(event: any): void
  {
    ...
    {
      let ddbody = this.studentSaveData != null ? `${this.studentSaveData.Id}/${this.FormParam.SelectedInstituteId}` : `${this.FormParam.SelectedStudentMasterId}/${this.FormParam.SelectedInstituteId}`;
      ...
      this._dashboardService.GetCurrentProfile(ddbody).subscribe((data: any) =>
      {
        ...
        if (this.MainAppliedData.PreEdu.length != 0)
        {
          let PreEdu_PSC_Data = this.MainAppliedData.PreEdu.filter(item => item.ExamCode === "1");
          this.MainAppliedPreEdu_PSC_Data = PreEdu_PSC_Data.length > 0 ? PreEdu_PSC_Data[0] : null;

          let PreEdu_JSC_JDC_Data = this.MainAppliedData.PreEdu.filter(item => item.ExamCode === "2");
          this.MainAppliedPreEdu_JSC_JDC_Data = PreEdu_JSC_JDC_Data.length > 0 ? PreEdu_JSC_JDC_Data[0] : null;

          let PreEdu_SSC_Dakhil_Data = this.MainAppliedData.PreEdu.filter(item => item.ExamCode === "3");
          this.MainAppliedPreEdu_SSC_Dakhil_Data = PreEdu_SSC_Dakhil_Data.length > 0 ? PreEdu_SSC_Dakhil_Data[0] : null;

          let PreEdu_HSC_Alim_Data = this.MainAppliedData.PreEdu.filter(item => item.ExamCode === "4");
          this.MainAppliedPreEdu_HSC_Alim_Data = PreEdu_HSC_Alim_Data.length > 0 ? PreEdu_HSC_Alim_Data[0] : null;

          let PreEdu_Hons_Fazil_Data = this.MainAppliedData.PreEdu.filter(item => item.ExamCode === "5");
          this.MainAppliedPreEdu_Hons_Fazil_Data = PreEdu_Hons_Fazil_Data.length > 0 ? PreEdu_Hons_Fazil_Data[0] : null;

          let PreEdu_Masters_Kamil_Data = this.MainAppliedData.PreEdu.filter(item => item.ExamCode === "6");
          this.MainAppliedPreEdu_Masters_Kamil_Data = PreEdu_Masters_Kamil_Data.length > 0 ? PreEdu_Masters_Kamil_Data[0] : null;

          let PreEdu_BBA_Data = this.MainAppliedData.PreEdu.filter(item => item.ExamCode === "7");
          this.MainAppliedPreEdu_BBA_Data = PreEdu_BBA_Data.length > 0 ? PreEdu_BBA_Data[0] : null;

          let PreEdu_MBA_Data = this.MainAppliedData.PreEdu.filter(item => item.ExamCode === "8");
          this.MainAppliedPreEdu_MBA_Data = PreEdu_MBA_Data.length > 0 ? PreEdu_MBA_Data[0] : null;
        }
        console.log(this.MainAppliedPreEdu_PSC_Data, 'this.MainAppliedPreEdu_PSC_Data');


        if (this.FormParam.SelectedGroupText == 'Humanities' && this.MainAppliedData != null)
        {
  ...
  CaLLApply(): void
  {
    let body = {
      "id": 0,
      "programID": this.FormParam.SelectedProgramId ? this.FormParam.SelectedProgramId : 0,
      "versionID": this.FormParam.SelectedVersionId ? this.FormParam.SelectedVersionId : 0,
      "shiftID": this.FormParam.SelectedShiftId ? this.FormParam.SelectedShiftId : 0,
      "studentCatID": this.FormParam.SelectedCategory ? this.FormParam.SelectedCategory : 0,
      "sessionID": this.FormParam.SelectedSessionId ? this.FormParam.SelectedSessionId : 0,
      "groupID": this.FormParam.SelectedGroup != "" ? Number(this.FormParam.SelectedGroup) : 0,
      "clientId": this.FormParam.SelectedInstituteId != "" ? Number(this.FormParam.SelectedInstituteId) : 0,
      "circularId": this.FormParam.SelectedCircularId != "" ? Number(this.FormParam.SelectedCircularId) : 0,
      "circularDetailId": this.FormParam.SelectedCircularDetailId != "" ? Number(this.FormParam.SelectedCircularDetailId) : 0,
      "formAmount": this.FormParam.SelectedFormAmount != 0 ? this.FormParam.SelectedFormAmount : 0,
      "studentMasterId": this.studentSaveData != null ? this.studentSaveData.Id : this.FormParam.SelectedStudentMasterId,
      "profileNo": this.studentSaveData != null ? this.studentSaveData.ProfileNo : this.FormParam.SelectedProfileNo,
      "tranStatus": 0,
      "verifyMethod": 0,
      "manualVerifyReference": "--",
      "gatewayId": 0,
      "bankTranId": "--",
      "channelName_Vendor": "--"
    }
    ...
    this._dashboardService.ProfileApply(body).subscribe((data: any) =>
    {
      console.log(data, "data");
      let acb = {
        // "clientId": this.FormParam.SelectedInstituteId != "" ? Number(this.FormParam.SelectedInstituteId) : "",
        // "circularDetailId": this.FormParam.SelectedCircularDetailId != "" ? Number(this.FormParam.SelectedCircularDetailId) : "",
        // "studentMasterId": this.studentSaveData != null ? this.studentSaveData.Id : this.FormParam.SelectedStudentMasterId,
      ...
      {
        if (data.data == "StudentExist")
        {
          this.matSnackBar.open("Student Already Exists", 'Close', {
            verticalPosition: 'top',
            duration: 2000,
          });
        ...
        else
        {
          ...
          if (data.data.FormAmount == 0)
          {
            localStorage.setItem('acb', JSON.stringify(acb));
            this._router.navigateByUrl("/dashboard/download");
            this.matSnackBar.open("Apply Successful", 'Close', {
              verticalPosition: 'top',
              duration: 2000,
            });
          } else
          {
            this.IniniatePayment(data.data);
            this.matSnackBar.open("Redirecting To payment Page", 'Close', {
              verticalPosition: 'top',
              duration: 2000,
            });
          }
  ...
  ApplyToDl(): void
  {
    if (this.FormParam.SelectedProgramType === "S")
    {
      if (this.MainAppliedData.FlagStudentInfoSaved === true &&
        this.MainAppliedData.FlagGuardianInfoSaved === true &&
        this.MainAppliedData.FlagAddressInfoSaved === true &&
        this.MainAppliedData.FlagLastEduInfoSaved === true)
      {
        this.CaLLApply();
      }
      else
      {
        this.matSnackBar.open("Please Submit All Information First", 'Close', {
          verticalPosition: 'top',
          duration: 2000,
        });
        return;
    ...
    if (this.FormParam.SelectedProgramType === "C")
    {
      if (this.MainAppliedData.FlagStudentInfoSaved === true &&
        this.MainAppliedData.FlagGuardianInfoSaved === true &&
        this.MainAppliedData.FlagAddressInfoSaved === true &&
        this.MainAppliedData.FlagPreEduInfoSaved === true &&
        this.MainAppliedData.FlagCourseInfoSaved === true)
      {
        this.CaLLApply();
      }
      else
  ...
  IniniatePayment(data): void
  {
    console.log(data, 'IniniatePayment param');
    ...
    console.log(body, 'IniniatePayment body');
  ...
  getPageData(): void
  {
    ...
    if (this.FormParam.SelectedStudentMasterId)
    {
      uibody = `${this.FormParam.SelectedInstituteId}/${this.FormParam.SelectedProgramType}/${this.FormParam.SelectedStudentMasterId}/${this.FormParam.SelectedApplicationFlag}/${this.FormParam.SelectedCircularId}`;
    } else
    {
      uibody = `${this.FormParam.SelectedInstituteId}/${this.FormParam.SelectedProgramType}/0/${this.FormParam.SelectedApplicationFlag}/${this.FormParam.SelectedCircularId}`;
    }

    console.log(uibody, 'uibody');

    let uibB = {
      "clientId": Number(this.FormParam.SelectedInstituteId),
      "programType": this.FormParam.SelectedProgramType,
      "editFlag": this.FormParam.SelectedApplicationFlag,
      "studentId": this.FormParam.SelectedStudentMasterId ? Number(this.FormParam.SelectedStudentMasterId) : 0,
      "circularId": Number(this.FormParam.SelectedCircularId),
      "programId": Number(this.FormParam.SelectedProgramId),

      // "clientId": 214,
      // "programType": "C",
      // "editFlag": "InCompleteApplication",
      // "studentId": 87111,
      // "circularId": 11,
      // "programId": 1043
    }

    console.log(uibB, 'uibB');

    let ddbody = this.FormParam.SelectedInstituteId;
    // let csbody = `${this.FormParam.SelectedInstituteId}/32`;

    let csbody = `${this.FormParam.SelectedInstituteId}/${this.FormParam.SelectedGroup}/${this.FormParam.SelectedVersionId}`;

    let _apiRequests = [
      // this._dashboardService.GetUiConfigs(uibody),
      this._dashboardService.GetUiConfigs(uibB),
        ...
        if (this.mainData != null)
        {
          ...
          this.horizontalStepperForm = this._formBuilder.group({
            ...
            addressInformation: this._formBuilder.group({
              ...
              permanentSameAs: [this.addressInfo.permanentSameAs.KeyValue ? this.addressInfo.permanentSameAs.KeyValue != "" ? this.addressInfo.permanentSameAs.KeyValue : "No" : "", this.addressInfo.permanentSameAs.Required ? Validators.required : null,],
            ...
            previousAcademicInformationforSchool: this._formBuilder.group({
              ...
              previousAcademicInfoSchoolTCNo: [this.previousAcademicInfoforSchool.previousAcademicInfoSchoolTCNo.KeyValue ? this.previousAcademicInfoforSchool.previousAcademicInfoSchoolTCNo.KeyValue : null, this.previousAcademicInfoforSchool.previousAcademicInfoSchoolTCNo.Required ? Validators.required : null,],
          ...
          if (this.FormParam.SelectedGroup == 31)
          {
  ...
  clearCC()
  {
    this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege3rdSubjectForHSC').setValue('');
    this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege4thSubjectForHSC').setValue('');

  }

  OnCom1SubjectSelect(event): void
  {
    let first = this.horizontalStepperForm.controls.courseCurriculumCollege.get('compulsorySubject1').value;
    let second = this.horizontalStepperForm.controls.courseCurriculumCollege.get('compulsorySubject2').value;
    let third = this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege3rdSubjectForHSC').value;
    let fourth = this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege4thSubjectForHSC').value;

    if (first === second)
    {
      this.matSnackBar.open("Compulsory Subject 1 & Compulsory Subject 2  Can't Be Same", 'Close', {
        verticalPosition: 'top',
        duration: 2000,
      });
      this.horizontalStepperForm.controls.courseCurriculumCollege.get('compulsorySubject2').setValue('');
      return;
    }

    if (first === third)
    {
      this.matSnackBar.open("Compulsory Subject 1 & 3rd Subject Can't Be Same", 'Close', {
        verticalPosition: 'top',
        duration: 2000,
      });
      this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege3rdSubjectForHSC').setValue('');
    ...
    if (first === fourth)
    {
      this.matSnackBar.open("Compulsory Subject 1 & 4th Subject Can't Be Same", 'Close', {
        verticalPosition: 'top',
        duration: 2000,
      });
      this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege4thSubjectForHSC').setValue('');
  ...
  OnCom2SubjectSelect(event): void
  {
    let first = this.horizontalStepperForm.controls.courseCurriculumCollege.get('compulsorySubject1').value;
    let second = this.horizontalStepperForm.controls.courseCurriculumCollege.get('compulsorySubject2').value;
    let third = this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege3rdSubjectForHSC').value;
    ...
    if (second === third)
    {
      this.matSnackBar.open("Compulsory Subject 2 & 3rd Subject Can't Be Same", 'Close', {
        verticalPosition: 'top',
        duration: 2000,
      });
      this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege3rdSubjectForHSC').setValue('');
    ...
    if (second === fourth)
    {
      this.matSnackBar.open("Compulsory Subject 2 & 4th Subject Can't Be Same", 'Close', {
        verticalPosition: 'top',
        duration: 2000,
      });
      this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege4thSubjectForHSC').setValue('');
  ...
  OnThirdSubjectSelect(event): void
  {
    let first = this.horizontalStepperForm.controls.courseCurriculumCollege.get('compulsorySubject1').value;
    let second = this.horizontalStepperForm.controls.courseCurriculumCollege.get('compulsorySubject2').value;
    let third = this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege3rdSubjectForHSC').value;
    ...
    if (this.FormParam.SelectedGroupText == 'Humanities')
    {
      if (second === third || first === third)
      {
        this.matSnackBar.open("Compulsory Subject 1/2 & 3rd Subject Can't Be Same", 'Close', {
          verticalPosition: 'top',
          duration: 2000,
        });
        this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege3rdSubjectForHSC').setValue('');
    ...
    if (third == fourth)
    {
      this.matSnackBar.open("Third & Fourth Subject Can't Be Same", 'Close', {
        verticalPosition: 'top',
        duration: 2000,
      });
      this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege4thSubjectForHSC').setValue('');
    ...
    let selectedThird = this.CurriculumSubjectsList.ThirdCourseList.filter(item => item.Value == third);

    if (selectedThird.length != 0 && selectedThird[0].ExcludedCourseIDGender != null)
    {
      if (this.MainAppliedData != null && this.MainAppliedData.StudentSex == selectedThird[0].ExcludedCourseIDGender)
      {
        let mes = selectedThird[0].ExcludedCourseIDGender == 'M' ? 'Males cant Select This Subject' : 'Females cant Select This Subject';
        this.matSnackBar.open(mes, 'Close', {
          verticalPosition: 'top',
          duration: 2000,
        });
        this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege3rdSubjectForHSC').setValue('');
  ...
  OnFourthSubjectSelect(event): void
  {
    let first = this.horizontalStepperForm.controls.courseCurriculumCollege.get('compulsorySubject1').value;
    let second = this.horizontalStepperForm.controls.courseCurriculumCollege.get('compulsorySubject2').value;
    let third = this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege3rdSubjectForHSC').value;
    ...
    if (this.FormParam.SelectedGroupText == 'Humanities')
    {
      if (second === fourth || first === fourth)
      {
        this.matSnackBar.open("Compulsory Subject 1/2 & 4th Subject Can't Be Same", 'Close', {
          verticalPosition: 'top',
          duration: 2000,
        });
        this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege4thSubjectForHSC').setValue('');
    ...
    let selectedFourth = this.CurriculumSubjectsList.FourthCourseList.filter(item => item.Value == fourth);

    if (selectedFourth.length != 0 && selectedFourth[0].ExcludedCourseIDGender != null)
    {
      if (this.MainAppliedData != null && this.MainAppliedData.StudentSex == selectedFourth[0].ExcludedCourseIDGender)
      {
        let mes = selectedFourth[0].ExcludedCourseIDGender == 'M' ? 'Males cant Select This Subject' : 'Females cant Select This Subject';
        this.matSnackBar.open(mes, 'Close', {
          verticalPosition: 'top',
          duration: 2000,
        });
    ...
    if (selectedThird.length != 0 && selectedThird[0].IncludedThirdSubjectCourseIDs != null)
    {
      let IncludedThirdSubjectCourseIDs = selectedThird[0].IncludedThirdSubjectCourseIDs.split(',');

      if (!IncludedThirdSubjectCourseIDs.includes(fourth))
      {
        this.matSnackBar.open("This Subject Cant Be Chosen With your Current Selected 3rd Subject", 'Close', {
          verticalPosition: 'top',
          duration: 2000,
        });
        this.horizontalStepperForm.controls.courseCurriculumCollege.get('courseCurriculumCollege4thSubjectForHSC').setValue('');
  ...
  OnGuardianSelect(event): void
  {
    let info = this.horizontalStepperForm.controls.guardianInformation.getRawValue();
    // console.log(info, "guardianInformation");

    if (event.value == 'Father')
    {
      this.horizontalStepperForm.controls.guardianInformation.patchValue({
        studentLocalGuardiansRelation: event.value,
        studentLocalGuardiansName: info.studentFathersName,
        studentLocalGuardiansContactNo: info.studentFathersContactNumber,
        studentLocalGuardiansEmail: info.studentFathersEmail,
        studentLocalGuardiansOccupation: info.studentFathersOccupation,
        studentLocalGuardiansDesignation: info.studentFathersDesignation,
        studentLocalGuardiansOfficeName: info.studentFathersOfficeName,
        studentLocalGuardiansNameBng: info.studentFathersNameBng,
        studentLocalGuardiansEducation: info.studentFathersEducation,
        studentLocalGuardiansNationalID: info.studentFathersNationalID,
        studentLocalGuardiansOfficeAddress: info.studentFathersOfficeAddress,
        studentLocalGuardiansOfficePhoneNo: info.studentFathersOfficePhoneNo,
        studentLocalGuardiansAnnualIncome: info.studentFathersAnnualIncome,
        studentLocalGuardiansTIN: info.studentFathersTIN,

      });
    }
    else if (event.value == 'Mother')
    {
      this.horizontalStepperForm.controls.guardianInformation.patchValue({
        studentLocalGuardiansRelation: event.value,
        studentLocalGuardiansName: info.studentMothersName,
        studentLocalGuardiansContactNo: info.studentMothersContactNumber,
        studentLocalGuardiansEmail: info.studentMothersEmail,
        studentLocalGuardiansOccupation: info.studentMothersOccupation,
        studentLocalGuardiansDesignation: info.studentMothersDesignation,
        studentLocalGuardiansOfficeName: info.studentMothersOfficeName,
        studentLocalGuardiansNameBng: info.studentMothersNameBng,
        studentLocalGuardiansEducation: info.studentMothersEducation,
        studentLocalGuardiansNationalID: info.studentMothersNationalID,
        studentLocalGuardiansOfficeAddress: info.studentMothersOfficeAddress,
        studentLocalGuardiansOfficePhoneNo: info.studentMothersOfficePhoneNo,
        studentLocalGuardiansAnnualIncome: info.studentMothersAnnualIncome,
        studentLocalGuardiansTIN: info.studentMothersTIN,
    ...
    {
      this.horizontalStepperForm.controls.guardianInformation.patchValue({
        studentLocalGuardiansRelation: "",
        studentLocalGuardiansName: "",
        studentLocalGuardiansContactNo: "",
        studentLocalGuardiansEmail: "",
        studentLocalGuardiansOccupation: "",
        studentLocalGuardiansDesignation: "",
        studentLocalGuardiansOfficeName: "",
        studentLocalGuardiansNameBng: "",
        studentLocalGuardiansEducation: "",
        studentLocalGuardiansNationalID: "",
        studentLocalGuardiansOfficeAddress: "",
        studentLocalGuardiansOfficePhoneNo: "",
        studentLocalGuardiansAnnualIncome: "",
        studentLocalGuardiansTIN: "",
      });
  ...
  Save_studentInformation()
  {
    ...
    let body = {};
    // const converted = new Date(tI_obj.birthDate).toLocaleDateString();

    // let dob = moment(tI_obj.birthDate).format();  //.format('YYYY-MM-DDThh:mm:ssZ');


    // console.log(tI_obj.birthDate, 'tI_obj.birthDate');
    // console.log(tI_obj.birthDate.toString(), 'tI_obj.birthDate ');
    // console.log(JSON.stringify(tI_obj.birthDate), 'tI_obj.birthDate ');
    // console.log(converted, 'converted');
    // console.log(dob, 'tI_obj.birthDate dob');



    if (this.FormParam.SelectedApplicationFlag == 'NewApplication')
    {
      ...
      body = {
        ...
        "programID": this.FormParam.SelectedProgramId ? this.FormParam.SelectedProgramId : 0,
        "subjectID": 0,//eft
        "groupID": this.FormParam.SelectedGroup != "" ? Number(this.FormParam.SelectedGroup) : 0,//eft
        "classID": 0,//eft
        "sectionID": 0,//eft
        "shiftID": this.FormParam.SelectedShiftId ? this.FormParam.SelectedShiftId : 0,
        "sessionID": this.FormParam.SelectedSessionId ? this.FormParam.SelectedSessionId : 0,
        "versionID": this.FormParam.SelectedVersionId ? this.FormParam.SelectedVersionId : 0,
        "studentCatID": this.FormParam.SelectedCategory ? this.FormParam.SelectedCategory : 0,
        "studentRoll": this.FormParam.SelectedSSCRoll ? this.FormParam.SelectedSSCRoll : 0,
        ...
        "nationalID": tI_obj.nationalID ? tI_obj.nationalID : "",
        "homeDisID": tI_obj.homeDisID ? tI_obj.homeDisID : null,
        "birthDate": tI_obj.birthDate ? moment(tI_obj.birthDate).format() : "",
        "birthID": tI_obj.birthID ? tI_obj.birthID : "",
        "religionID": tI_obj.religionID ? tI_obj.religionID : null,
        ...
        "interestedClub": "", //tI_obj.interestedClub ? tI_obj.interestedClub : "",
      ...
      this._dashboardService.SaveStudentForm(body, this.FormParam.SelectedInstituteId).subscribe((data: any) =>
      {
        console.log(data, "data");
        if (data.isError == false)
        {
          ...
          else
          {
            ...
            // this.FormParam.SelectedApplicationFlag = 'InCompleteApplication';
            // this.FormParam.SelectedStudentMasterId = this.studentSaveData.Id;
            // this.FormParam.SelectedProfileNo = this.studentSaveData.ProfileNo;
            // this.FormParam.SelectedStudentId = this.studentSaveData.StudentID;

            // this._dashboardService.FormParam = JSON.stringify(this.FormParam);
            // this.FormParam = JSON.parse(this._dashboardService.FormParam);
            // this.getPageData();
            // localStorage.setItem('studentSaveData', JSON.stringify(this.studentSaveData));
    ...
    {
      body = {
        "id": this.FormParam.SelectedStudentMasterId,
        "clientId": this.FormParam.SelectedInstituteId ? Number(this.FormParam.SelectedInstituteId) : "",
        // "sourceID": 1,
        // "programID": this.FormParam.SelectedProgramId ? this.FormParam.SelectedProgramId : 0,
        // "subjectID": 0,//eft
  ...
  Save_guardianInformation()
  {
    ...
    if (this.studentSaveData == null && this.FormParam.SelectedApplicationFlag == 'NewApplication')
    {
  ...
  Save_previousAcademicInformationforSchool()
  {
    ...
    {
      preEduBody = Utils.PreEduBuild(si_form, this.mainData.ExamCodes, this.studentSaveData, this.FormParam);
  ...
  Save_courseCurriculumCollege()
  {
    ...
    let body = {
      "clientId": this.FormParam.SelectedInstituteId ? Number(this.FormParam.SelectedInstituteId) : "",
      "studentId": this.studentSaveData != null ? this.studentSaveData.Id : this.FormParam.SelectedStudentMasterId,
    ...
    this._dashboardService.SaveCourseCurriculumCollegeForm(body, this.FormParam.SelectedInstituteId, this.FormParam.SelectedGroup).subscribe((data: any) =>
    {
      // console.log(data, "data");
  ...
  onSelectionClub(event): void
  {
    // console.log(event, 'event');

    console.log(this.horizontalStepperForm.controls.studentInformation.get('studentInterestedClub').value, 'studentInterestedClub');


    let filteredClubs = this.MainDropdownData.InterestedClubs.filter(club => event.source._value.includes(club.Value));
    console.log(filteredClubs, 'filteredClubs');


    let mainValues = filteredClubs.map((item) =>
    {
      return item.ThirdValue;
    });
    ...
    this.selectedICs = filteredClubs;

    console.log(this.selectedICs, 'this.selectedICs');

    if (!this.selectedIC_MainIds.includes("33"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('CulturalClubAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("34"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('BengaliDebateClubAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("35"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('EnglishDebateClubAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("37"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('SportsClubAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("38"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('ScienceClubAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("47"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('BNCCClubAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("57"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('MusicClubAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("58"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('DanceClubAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("59"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('LanguageClubAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("60"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('SwimmingClubAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("61"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('BusinessAndCareerClubAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("62"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('MediaClubAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("63"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('RedCrescentAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("64"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('GirlsGuideAchievement').setValue("")
    }

    if (!this.selectedIC_MainIds.includes("65"))
    {
      this.horizontalStepperForm.controls.studentInformation.get('ScoutAchievement').setValue("")
    }

    // if (event.source._value.includes("Music"))
    // {
    //   this.horizontalStepperForm.controls.studentInformation.get('MusicClubAchievement').enable();
    // }
    // else
    // {
    //   this.horizontalStepperForm.controls.studentInformation.get('MusicClubAchievement').disable();
    //   this.horizontalStepperForm.controls.studentInformation.get('MusicClubAchievement').setValue("")
    // }

    // if (event.source._value.includes("Dance"))
    // {
    //   this.horizontalStepperForm.controls.studentInformation.get('DanceAchievement').enable();
    // }
    // else
    // {
    //   this.horizontalStepperForm.controls.studentInformation.get('DanceAchievement').disable();
    //   this.horizontalStepperForm.controls.studentInformation.get('DanceAchievement').setValue("");
    // }

    // if (event.source._value.includes("BNCC"))
    // {
    //   this.horizontalStepperForm.controls.studentInformation.get('BNCCAchievement').enable();
    // }
    // else
    // {
    //   this.horizontalStepperForm.controls.studentInformation.get('BNCCAchievement').disable();
    //   this.horizontalStepperForm.controls.studentInformation.get('BNCCAchievement').setValue("");
    // }

    // if (event.source._value.includes("Scout"))
    // {
    //   this.horizontalStepperForm.controls.studentInformation.get('ScoutAchievement').enable();
    // }
    // else
    // {
    //   this.horizontalStepperForm.controls.studentInformation.get('ScoutAchievement').disable();
    //   this.horizontalStepperForm.controls.studentInformation.get('ScoutAchievement').setValue("");
    // }

    // if (event.source._value.includes("RedCrescent"))
    // {
    //   this.horizontalStepperForm.controls.studentInformation.get('RedCrescentAchievement').enable();
    // }
    // else
    // {
    //   this.horizontalStepperForm.controls.studentInformation.get('RedCrescentAchievement').disable();
    //   this.horizontalStepperForm.controls.studentInformation.get('RedCrescentAchievement').setValue("");
    // }
  }
...
// let UIConfigResponseViewModels = [
//   { FormName: 'Address Information', ProgramType: 'S', FormGroupId: 'Address_Information', UIConfigItems: Array(59) },
//   { FormName: 'Course Curriculum College', ProgramType: 'C', FormGroupId: 'Course_Curriculum_College', UIConfigItems: Array(2) },
//   { FormName: 'Guardian Information', ProgramType: 'S', FormGroupId: 'Guardian_Information', UIConfigItems: Array(68) },
//   { FormName: 'Previous Academic Information Collage', ProgramType: 'C', FormGroupId: 'Previous_Academic_Information_Collage', UIConfigItems: Array(21) },
//   { FormName: 'Previous Academic Information School', ProgramType: 'S', FormGroupId: 'Previous_Academic_Information_School', UIConfigItems: Array(10) },
//   { FormName: 'Student Information', ProgramType: 'S', FormGroupId: 'Student_Information', UIConfigItems: Array(34) },
//   {
//     FormName: 'Pre Edu Info', ProgramType: 'S', FormGroupId: 'Pre_Edu_Info',
//     psc_UIConfigItems: [],
//     jsc_UIConfigItems: [],
//   },
// ]
