...
import { AdmssionStudentImportComponent } from './admssion-student-import.component';
...
const dashboardRoutes: Route[] = [
  {
    path: "",
    component: AdmssionStudentImportComponent,
  }
];

@NgModule({
  declarations: [
    AdmssionStudentImportComponent,
...
export class AdmssionStudentimportModule
{
}
