...
export class DateSelectorControl extends BaseControl<string> {
    controlType = 'dateSelector';
    type: string;
    ...
    static getFromJsonObj(obj: any): DateSelectorControl
    {
        return new DateSelectorControl({
